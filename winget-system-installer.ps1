...
if( $null -eq $wingetCommand)
{
	...
	Invoke-WebRequest "https://github.com/microsoft/winget-cli/releases/download/v1.3.2091/Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle" -OutFile Microsoft.DesktopAppInstaller.msixbundle
